...
func (dl LoaderV2) LoadAttachment(_ context.Context, _ envelopes.ID, _ *envelopes.Attachment) error {
	return fmt.Errorf("Attachment is unsupported by format JSONV2")
}
